...
Se questo non è presente si rimanda ad una guida esterna ([windows](https://sqlbackupandftp.com/blog/setting-windows-path-for-postgres-tools/) oppure [unix-like](https://superuser.com/questions/1116415/bash-psql-command-not-found))  (per il corretto proseguimento nell'installazione<br>
